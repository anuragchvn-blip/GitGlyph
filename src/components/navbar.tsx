  ...
  return (
    ...
    >
      <div className="w-[calc(100%-24px)] max-w-[1400px] mt-2">
        <nav
          className={`flex items-center justify-between p-2 h-16 bg-black rounded-[16px] text-white font-geist transition-all duration-300 ${
            scrolled ? 'border border-gray-800 shadow-lg' : 'border border-transparent'
          }`}
        >
          <div className="flex items-center ml-[15px]">
            ...
            <span
              className="logo-text font-geist text-lg leading-tight font-semibold text-white tracking-tight"
            >
              GitGlyph
            </span>
          </div>
